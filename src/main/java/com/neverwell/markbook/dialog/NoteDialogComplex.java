 ...
 * @Description:
 */
public class NoteDialogComplex extends JDialog {
    ...
    public NoteDialogComplex(Project project) {
    ...
    public NoteDialogComplex(Project project, Integer index, NoteData noteData) {
        this.project = project;
        init(noteData);
